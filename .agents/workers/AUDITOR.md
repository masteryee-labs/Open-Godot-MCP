...
> Dispatched via `.agents/DISPATCH_TEMPLATES.md` §3. Fresh-context per `.agents/canon/VERIFICATION_PROTOCOL.md`.
...
- Before declaring a task complete — **but the done-gate itself is `fable-judge`** (event-driven,
  ...
  first; Auditor adds the 8-angle breadth sweep. See `.agents/skills/fable-judge.md`.
