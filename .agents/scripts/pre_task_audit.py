...
Usage:
    python .agents/scripts/pre_task_audit.py --files scripts/sync.py,adapters/base.py --tags concurrency
    python .agents/scripts/pre_task_audit.py --files scripts/sync.py --session s-20260709-abc
