---
name: memory-audit
description: "Use every 5 iterations, when scope changes, or before session end. Invokes .agents/scripts/memory_audit.py to review candidate memories, prune stale ones, and distills reusable patterns into knowledge_distill.md."
---
...
1. Call `python .agents/scripts/memory_audit.py --session <session_id>`.
...
```
## Memory audit
- script: python .agents/scripts/memory_audit.py --session <session_id>
- accepted: N
- discarded: N
