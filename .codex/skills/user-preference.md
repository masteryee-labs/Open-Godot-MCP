...
description: "Use at BOOT and whenever a user preference is discovered. Loads and updates .codex/user_profile.md to remember language, model tier, project type, and custom red lines."
---
...
1. Read `.codex/user_profile.md` if it exists.
...
```
## User profile
- loaded from: .codex/user_profile.md
- updated: <fields>
