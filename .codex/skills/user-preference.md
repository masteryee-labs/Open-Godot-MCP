...
3. Update fields based on the current session:
   ...
   - `project_rules_dir` if the project has a `.codex/rules/` directory with detailed project-specific rules.
   - `project_rules_index` if there's an index file (e.g., `.codex/rules/project_rules.md`).
