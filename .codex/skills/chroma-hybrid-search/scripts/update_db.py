...
Usage (from repo root):
    ...
    <PY> .codex/skills/chroma-hybrid-search/scripts/update_db.py --workspace ~/.deep-memory
...
def main():
    ...
    try:
        ...
        print("[update-db] run: <PY> -m pip install -r .codex/skills/chroma-hybrid-search/requirements.txt")
        return
