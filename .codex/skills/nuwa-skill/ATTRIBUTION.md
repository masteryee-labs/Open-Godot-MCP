# .codex/skills/nuwa-skill/ — Vendored Nuwa Skill
...
This is the same philosophy as `.codex/skills/assets/vault/` — no runtime fetch, no network dependency.
...
2. During sync, `adapters/base.py` copies `.codex/skills/nuwa-skill/` into each
