...
Usage:
    python .codex/scripts/pre_task_audit.py --files scripts/sync.py,adapters/base.py --tags concurrency
    python .codex/scripts/pre_task_audit.py --files scripts/sync.py --session s-20260709-abc
...
try:
    ...
    # In .codex/scripts/ we can import from the same directory
