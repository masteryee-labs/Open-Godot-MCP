...
Usage:
    python .windsurf/scripts/pre_task_audit.py --files scripts/sync.py,adapters/base.py --tags concurrency
    python .windsurf/scripts/pre_task_audit.py --files scripts/sync.py --session s-20260709-abc
...
try:
    ...
    # In .windsurf/scripts/ we can import from the same directory
