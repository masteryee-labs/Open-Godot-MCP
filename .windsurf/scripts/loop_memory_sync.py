...
def regenerate(root: Path, session_id: str = "", status: str = "") -> None:
    ...
    lines.append("")
    lines.append("## Links")
    lines.append("- knowledge_distill: .windsurf/knowledge_distill.md")
    lines.append("- handoff_letter: .windsurf/handoff_letter.md")
    lines.append("- session_archive: .windsurf/loop_state_archive.md")
    lines.append("- session_archive_dir: .windsurf/loop_state_archive/")
