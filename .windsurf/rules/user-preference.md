...
description: "Use at BOOT and whenever a user preference is discovered. Loads and updates .windsurf/user_profile.md to remember language, model tier, project type, and custom red lines."
---
...
1. Read `.windsurf/user_profile.md` if it exists.
...
```
## User profile
- loaded from: .windsurf/user_profile.md
- updated: <fields>
