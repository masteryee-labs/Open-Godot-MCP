...
- Before writing the final `.devin/handoff_letter.md`.
...
2. The script does the following:
   ...
   - If all three exist, merge into `.devin/knowledge_distill.md` in the format:
     ```
   ...
   - If `.devin/knowledge_distill.md` exceeds 8KB, run a distillation pass:
     - merge duplicates
...
3. You may also read the audit output from the script and append any high-level judgment to `.devin/handoff_letter.md`.
