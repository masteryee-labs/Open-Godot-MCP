...
Usage (from repo root):
    ...
    <PY> .hermes/skills/chroma-hybrid-search/scripts/update_db.py --workspace ~/.deep-memory
...
def main():
    ...
    try:
        ...
        print("[update-db] run: <PY> -m pip install -r .hermes/skills/chroma-hybrid-search/requirements.txt")
        return
