# .hermes/skills/nuwa-skill/ — Vendored Nuwa Skill
...
This is the same philosophy as `.hermes/skills/assets/vault/` — no runtime fetch, no network dependency.
...
2. During sync, `adapters/base.py` copies `.hermes/skills/nuwa-skill/` into each
