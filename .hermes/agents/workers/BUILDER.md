...
> Dispatched via `.hermes/agents/DISPATCH_TEMPLATES.md` §2.
...
- Do not verify your own output is correct — per `.hermes/canon/VERIFICATION_PROTOCOL.md` (that's Verifier).
- Do not edit canon or entry files.
- Do not hardcode values — use config/keys/CSV/JSON per `.hermes/canon/REDLINES.md`.
