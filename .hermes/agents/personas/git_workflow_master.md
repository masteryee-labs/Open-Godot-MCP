...
- **Note**: Agent Harness Deploy worktree isolation (`.hermes/scripts/worktree.py`) uses Git worktrees for parallel dispatch. This persona ensures the Git side of that workflow is clean.
