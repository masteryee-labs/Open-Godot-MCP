...
Caveat (from .hermes/canon/LOOP_PROTOCOL.md §5+1 components):
...
Usage by the Commander:
  Before parallel dispatch:
    1. python .hermes/scripts/plan_dispatch.py --analyze  ??get file ownership map
    2. python .hermes/scripts/worktree.py create builder-a
    3. python .hermes/scripts/worktree.py create builder-b
    4. dispatch Builder-A to .worktrees/builder-a/ with owned_files=[...]
    5. dispatch Builder-B to .worktrees/builder-b/ with owned_files=[...]
  After both report:
    6. python .hermes/scripts/worktree.py merge builder-a
    7. python .hermes/scripts/worktree.py merge builder-b
    8. python .hermes/scripts/worktree.py clean
"""
...
def cmd_merge(worker_id: str) -> int:
    ...
    if rc != 0:
        ...
        print(f"      Resolve conflicts manually, then run: python .hermes/scripts/worktree.py remove {worker_id}")
